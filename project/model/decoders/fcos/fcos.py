...
class SharedDecoder2d(nn.Sequential):
    ...
    def __init__(
        ...
        for i in range(num_convs):
            ...
            dw = nn.Conv2d(in_channels, in_channels, 3, padding=1, groups=in_channels, bias=False)
            pw = nn.Conv2d(in_channels, out, 1, bias=is_last_repeat)
